...
The `openspec-archive-change` skill is extended by openspec-orbit with:
...
See `.claude/skills/openspec-archive-change/SKILL.md` for full pre-archive sweep logic, audit branching, and edge-case handling.